# Ordnance — Iran Squadron database

A responsive air, ground and infantry dashboard built from three supplied War Thunder data workbooks.
...
The build validates and embeds all three JSON datasets. Tests verify source counts, relationship joins, air carrier filtering, missing values and BR calculations.
